...
public class MenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button auButton = view.findViewById(R.id.auFlagButton);
        ...
        if (noteViewModel.getClickedValue() == 2){
            (view.findViewById(R.id.notePane)).setVisibility(View.VISIBLE);
            titleView = (TextView)(view.findViewById(R.id.titleText));
            title = noteViewModel.getTitle();
            titleView.setText(title);
            noteView = (TextView)(view.findViewById(R.id.bodyText));
            note = noteViewModel.getNote();
            noteView.setText(note);
            auButton.setText("Edit note");
        }
        return view;
    }
}
